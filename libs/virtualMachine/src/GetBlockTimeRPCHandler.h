...
class GetBlockTimeRPCHandler
    : public RPCResponseHandler,
      private SingleThread {

    GlobalEnvironment& m_environment;
    supercontractserver::GetBlockTime m_request;
    std::weak_ptr<VirtualMachineBlockchainQueryHandler> m_handler;
    std::shared_ptr<AsyncQueryCallback<supercontractserver::GetBlockTimeReturn>> m_callback;
    std::shared_ptr<AsyncQuery> m_query;

public:
    GetBlockTimeRPCHandler(GlobalEnvironment& environment,
