...
class GetBlockGenerationTimeRPCHandler
    : public RPCResponseHandler,
      private SingleThread {

    GlobalEnvironment& m_environment;
    supercontractserver::GetBlockGenerationTime m_request;
    std::weak_ptr<VirtualMachineBlockchainQueryHandler> m_handler;
    std::shared_ptr<AsyncQueryCallback<supercontractserver::GetBlockGenerationTimeReturn>> m_callback;
    std::shared_ptr<AsyncQuery> m_query;

public:
    GetBlockGenerationTimeRPCHandler(GlobalEnvironment& environment,
