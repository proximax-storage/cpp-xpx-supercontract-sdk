...
class GetBlockHeightRPCHandler
    : public RPCResponseHandler,
      private SingleThread {

    GlobalEnvironment& m_environment;
    supercontractserver::GetBlockHeight m_request;
    std::weak_ptr<VirtualMachineBlockchainQueryHandler> m_handler;
    std::shared_ptr<AsyncQueryCallback<supercontractserver::GetBlockHeightReturn>> m_callback;
    std::shared_ptr<AsyncQuery> m_query;

public:
    GetBlockHeightRPCHandler(GlobalEnvironment& environment,
