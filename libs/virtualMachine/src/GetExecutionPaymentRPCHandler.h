...
class GetExecutionPaymentRPCHandler
    : public RPCResponseHandler,
      private SingleThread {

    GlobalEnvironment& m_environment;
    supercontractserver::GetExecutionPayment m_request;
    std::weak_ptr<VirtualMachineBlockchainQueryHandler> m_handler;
    std::shared_ptr<AsyncQueryCallback<supercontractserver::GetExecutionPaymentReturn>> m_callback;
    std::shared_ptr<AsyncQuery> m_query;

public:
    GetExecutionPaymentRPCHandler(GlobalEnvironment& environment,
