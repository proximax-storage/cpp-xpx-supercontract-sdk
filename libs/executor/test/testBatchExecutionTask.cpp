...
//    }
//
//    std::vector<ExecutorKey> executorKeys;
//    for(int i = 0; i < 3; i++) {
//        executorKeys.push_back(utils::generateRandomByteValue<ExecutorKey>());
//    }
//
//    std::vector<SuccessfulEndBatchExecutionOpinion> opinionList;
//
//    // Note, not all the executors send opinions, i.e. 2 < executorsKeys.size()
//    for (int i = 0; i < 2; i++) {
//        SuccessfulEndBatchExecutionOpinion opinion;
//        opinion.m_batchIndex = 1;
//        opinion.m_contractKey = contractKey;
//        opinion.m_executorKey = executorKeys[i];
...
//            pContractEnvironmentMock->m_executors.try_emplace(executorKeys[i],
//                                                              ExecutorInfo{});
//        }
//
...
//    threadManager.execute([&] {
//        pContractEnvironmentMock = std::make_unique<ContractEnvironmentMock>(
//                executorEnvironmentMock, contractKey, automaticExecutionsSCLimit, automaticExecutionsSMLimit, config);
//
//        pBatchExecutionTask = std::make_unique<BatchExecutionTask>(std::move(batch),
//                                                                   *pContractEnvironmentMock,
//                                                                   executorEnvironmentMock,
