...
void HttpsInternetResource::open(std::shared_ptr<AsyncCallback<InternetResourceContainer>> callback) {
...
void HttpsInternetResource::read(
        std::shared_ptr<AsyncCallback<std::optional<std::vector<uint8_t>>>> callback) {
