...
class BaseContractTask
        : protected SingleThread, public ContractMessageEventHandler, public ContractBlockchainEventHandler {
protected:
...
createRemoveContractTask(RemoveRequest&& request, ContractEnvironment&, ExecutorEnvironment&);
